...
// This runs on the server, fetches your live stats, and sends HTML to the user!
...
async function getLeetCodeStats() {
  try {
    const res = await fetch("https://leetcode-stats-api.herokuapp.com/AdityaTechie", {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col justify-between aspect-square hover:bg-white/10 transition-colors">
            ...
            <div>
              <p className="text-5xl font-bold text-white mb-2">{githubData?.public_repos || "0"}</p>
              <p className="text-zinc-400 font-medium">Public Repositories</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col justify-between aspect-square hover:bg-white/10 transition-colors">
            ...
            <div>
              <p className="text-5xl font-bold text-white mb-2">{githubData?.followers || "0"}</p>
              <p className="text-zinc-400 font-medium">GitHub Followers</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col justify-between aspect-square hover:bg-white/10 transition-colors">
            ...
            <div>
              ...
              <p className="text-zinc-400 font-medium">LeetCode Problems Solved</p>
            </div>
          </div>
